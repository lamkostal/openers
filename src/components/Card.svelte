...
<div
  ...
  {#if free}
    <div class="ribbon script-text">free</div>
  {/if}
  <div class="thumb">
  ...
  <div class="text">
    ...
    <div class="description">
      ...
      {:else}
        <div class="description_details">
          <p>
            Add your own text, img, brand, logo or whatever you can think of,
    ...
    <div class="buttons_wrap">
      {#if free}
        <span class="card-text-block">
          ...
          <a
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="interact-icon icon icon--download"
              width="28"
              height="28"
              viewBox="0 0 24 24"
              stroke-width="2"
      ...
      <span class="card-text-block">
        ...
        <a href="#contact" title="contact">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="interact-icon icon icon--contact"
            width="28"
            height="28"
            viewBox="0 0 24 24"
            stroke-width="2"
